...
The goal of planThis is to simplify time keeping in the EA. It uses categorised outlook appointments to create time cards weighted against free time and daily hours.
...
>  **_Calendar page on outlook_** **_>>_** **_file_** **_>>_** **_Open & Export_** **_>>_** **_Import/Export_** **_>>_** **_Export to a file_** **_>>_** **_Comma Separated Values_**
